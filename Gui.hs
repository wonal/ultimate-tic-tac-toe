...
grid = Pictures [outerGrid, innerGrid, Translate (-unit) 0 innerGrid, Translate unit 0 innerGrid,
                  ...
                  -- Pictures [Translate x y innerGrid | x <- [-unit, 0, unit], y <- [-unit, 0, unit]]

markXO :: OuterGame -> Picture
markXO g = Pictures [if (fst x == X) then drawX (snd x) (1.0) else drawO (snd x) (1.0) (0.0) black | 
...
displayWins gs = Pictures [if (fst x == X) then drawX (snd x) (4.0) else drawO (snd x) (4.0) (0.0) black | 
                          x <- filter (\(a,b) -> a /= E) (zip gs cells)]
...
centerGrid :: [Points]
centerGrid = [((-b,a),(-a,b)), ((-a,a),(a,b)), ((a,a),(b,b)), ((-b,-a),(-a,a)), ((-a,-a),(a,a)), ((a,-a),(b,a)), 
              ((-b,-b),(-a,-a)), ((-a,-b),(a,-a)), ((a,-b),(b,-a))]

--Corner points of the outer cells
cells :: [Points]
cells = [(((fst(fst ps))*(4.0),(snd(fst ps))*(4.0)),((fst(snd ps))*(4.0),(snd(snd ps))*(4.0))) | ps <- centerGrid]
